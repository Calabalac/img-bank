        ...
        <TableBody>
          {images.map((image) => (
            ...
            >
              ...
              <TableCell>
                <div className="w-12 h-12 bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg overflow-hidden">
                  <img
              ...
              <TableCell>
                <div className="font-medium text-white truncate max-w-64" title={image.original_name}>
                  {image.original_name}
                </div>
              </TableCell>
              
              <TableCell>
                <span className="text-slate-300">{formatFileSize(image.file_size)}</span>
              </TableCell>
              
              <TableCell>
                <span className="text-slate-300">{image.mime_type}</span>
              </TableCell>
              ...
              <TableCell>
                <code className="text-xs bg-slate-800/50 backdrop-blur-md border border-white/10 px-2 py-1 rounded font-mono text-slate-300 block truncate max-w-48">
